  ...
  .phone-confirmation
    ...
    div(v-show="phoneSend").phone-confirmation__code
      ...
      div.phone-confirmation__code-field
        Input(:rules="['required', 'phoneCode']" label="Код из СМС" name="code" :mask="INPUT_MASKS.smsCode" :placeholder="INPUT_PLACEHOLDERS.smsCode" @input="handleCodeInput" ref="codeInput").form__input
        div(v-if="error").phone-confirmation__error {{error}}
        .tac
