  ...
  function a(r, a) {
    ...
    return i(a, function () {
      function a(a) {
        ...
        i.length || (i = t('<div id="kladr_autocomplete"></div>')
        .appendTo(n.body));
        var l = B('guid');
        l ? (V = i.find('.autocomplete' + l), A = i.find('.spinner' + l), t(e)
        .off(z), r.off(z), V.off(z)) : (l = o(), P('guid', l), r.attr('autocomplete', 'off'), V = t('<ul class="autocomplete' + l + ' autocomplete" style="display: none;"></ul>')
        .appendTo(i), A = t('<div class="spinner' + l + ' spinner" style="display: none;"></div>')
        .appendTo(i), k(), d(), b()), a();
      }
      ...
      function i(e, n) {
        ...
        for (var l = 0; l < e.length; l++) {
          ...
          var u = a.replace(/(["])/g, '\\$1'),
            ...
            .text()
            .replace(/(["])/g, '\\$1');
          o = t('<a data-val="' + u + '">' + i + '</a>'), o.data('kladr-object', r), t('<li title="' + s + '"></li>')
          .append(o)
          .appendTo(V);
        }
      }
      ...
      function s() {
        var e,
          n,
          r;
        V.empty(), e = '', n = u.noResultText, null != n && '' != n && (r = t('<a data-val="' + e + '">' + n + '</a>'), r.data('kladr-object', {}), t('<li></li>')
        .append(r)
        .appendTo(V));
      }
      ...
      function y(t) {
        ...
        switch (t.which) {
          case f.up:
            e.length ? (e.removeClass('active'), e.prev().length && (e = e.prev())) : e = V.find('li')
            .last(), function () {
              var t = V.scrollTop(),
                n = V.offset(),
                r = e.outerHeight(),
            ...
            break;
          case f.down:
            e.length ? (e.removeClass('active'), e.next().length && (e = e.next())) : e = V.find('li')
            .first(), e.length && !function () {
              var t = V.scrollTop(),
                n = V.height(),
                r = V.offset(),
                a = e.outerHeight(),
      ...
      function g() {
        if (w('select_before')) {
          ...
          t.length && (r.val(t.attr('data-val'))
          .data(F, !0), x(!1), _(t.data('kladr-object')), w('select', B('current')));
        }
      }
      ...
      function w(e, n, a) {
        ...
        return r.trigger('kladr_' + e, n), 'function' !== t.type(B(i)) || B(i)
        .call(r.get(0), n, a) !== !1;
      }
      ...
      a(function () {
        var n = !1,
          a = !0,
          i = '';
        r.attr('data-kladr-type', B('type') || '')
        .attr('data-kladr-one-string', B('oneString') || null)
        .on('keyup' + z, p)
        .on('keydown' + z, y)
        .on('blur' + z, function () {
    ...
    setValues: function (e, n, r) {
      ...
      if (~t.inArray(t.type(e), ['object', 'array'])) {
        ...
        a = t.fias.getInputs(n), function c() {
          ...
          if (e) {
            return t = a.filter('[data-kladr-type="' + e + '"]'), t.length ? void t.on(o, function () {
              t.off(o), c();
            })
            .fias('controller')
            .setValue(n, r) : void c();
